          ...
          {STATS.map((stat, i) => (
            <div
              ...
              className={`flex flex-col items-center text-center px-4 md:px-8 ${
                i < STATS.length - 1 ? "lg:border-r lg:border-primary/15" : ""
              }`}
            >
              {/* Línea decorativa vertical */}
              <div className="w-1 h-10 bg-secondary rounded-full mb-4" />

              <div className="font-display font-black text-2xl sm:text-3xl lg:text-5xl text-primary tracking-tighter leading-none">
